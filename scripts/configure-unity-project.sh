...
LOG_FILE="$PROJECT_DIR/Logs/unity-project-configurator.log"
...
"$UNITY_BIN" \
  ...
  -logFile "$LOG_FILE" \
  -executeMethod Leggau.Editor.UnityProjectConfigurator.ConfigureAndValidateForLeggau \
  -quit

echo "Unity project configuration finished. Log: $LOG_FILE"
